...
<body>
    <?php include('element_header.php') ?>
    <div class="enter"></div>
    <?php include('menu_bar.php') ?>
    <div class="enter"></div>
    <div class="kolom1">
        Dalam pemrograman berorientasi objek, fungsi include sudah merupakan hal yang wajib ada. Fungsi include merupakan fungsi yang digunakan untuk menyertakan file lain ke dalam file yang sedang diproses.
    </div>
    <div class="kolom2">
        Fungsi Include
